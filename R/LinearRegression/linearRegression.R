...
## Define a modular estimation function to allow hotplugging of fitting functions 
# .lmFunction <- function(form, data, weights, FUN = NULL, ...) {
#   if (is.null(FUN))
#     stats::lm(formula = form, data = data, weights = weights, ...)
#   else 
#     FUN(formula = form, data = data, weights = weights, ...)
# }
